...
export class Backend implements backendInterface {
    ...
    async addEmployee(arg0: string, arg1: string, arg2: string, arg3: string): Promise<void> {
        if (this.processError) {
            try {
    ...
    async clearAttendanceLogs(): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.clearAttendanceLogs();
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async getAllFaceDescriptors(): Promise<Array<FaceDescriptorRecord>> {
        if (this.processError) {
            try {
    ...
    async getFaceDescriptor(arg0: string): Promise<Array<number>> {
        if (this.processError) {
            try {
                const result = await this.actor.getFaceDescriptor(arg0);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async markAttendance(arg0: string, arg1: bigint): Promise<void> {
        if (this.processError) {
            try {
    ...
    async saveFaceDescriptor(arg0: string, arg1: Array<number>): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.saveFaceDescriptor(arg0, arg1);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
